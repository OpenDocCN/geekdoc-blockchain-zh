...
正如蜜罐吸引蜜蜂，数据也吸引罪犯！偶尔，数据会被泄露。您可能还记得近年来新闻头条中的 Equifax、Dropbox、Yahoo 等大型组织的安全漏洞。这些都是花费数十亿美元在网络安全上的大型组织。*太好了，更多的人拥有我的信息*，每当我看到数据盗窃的新闻时，我都会这样想。但我不会因此恐慌或失眠。为什么？这种情况一直在发生。蜜罐模式已经完全失效。
...
今天，基本上没有竞争或激励促使公司在社交平台上进行创新。如果你阅读一家公司的服务条款和隐私政策，不同意并拒绝同意，你的选择是什么？你将被抛在数字革命的后面。如果你是一家小公司，不想将你的数字自我交给 Facebook，从技术上讲你有权拒绝他们的条款并不使用他们的服务。但没有访问最广泛使用的销售和广告平台，你的业务将无法生存，更不用说竞争了。你注意到 LinkedIn、Facebook 或 Amazon 是否有意义地替代品存在吗？如果 LinkedIn 有一天决定在你艰苦的求职过程中取消你的资料，你会怎么办？这难道不是毁灭性的吗？雇主还能在哪里找到你？

第四，如果我们确立了清晰、不可让渡、个体对数字双胞胎的所有权，我们将鼓励现有服务有意义替代品的发展。这些社交平台和服务可能的替代品进入门槛如此之高的主要原因是，每个现有公司已经控制了如此多的领土和信息。每个公司在其领域内都是垄断者，拥有我们数字双胞胎的每一个部分。

任何想要通过创建替代品进入市场的人都将不得不从头开始——并且立即与一个确立的巨头竞争。而且我们的档案是不可移动的。用户无法以任何有意义或有效的方式将他们的联系、活动或评论移动到竞争平台或服务上，即使存在这样的服务。

第五，我们的数字双胞胎是我们自己劳动的果实。我们在档案上投入了大量的时间和精力。我们决定上传哪些图片，与谁分享信息，以及对别人的帖子发表什么评论。创建数字双胞胎是一种创造性的行为。如果我们的精力都投入到了创造它，那么它属于我们。

我们使用 discretion（自主权）的事实并不意味着它不属于我们自己的财产，或者不是我们自身的延伸；事实上，选择如何表达自己或许是我们身份最亲密的延伸。仅仅因为一个艺术家使用了商业颜料（而不是自己制作），这并不意味着颜料公司就拥有他的作品。他做出了如何使用那种颜料的决定，这些决定是他个人愿景和身份的极其私人的反映。为什么数字自我的所有权不应该属于创造者，就像画作的所有权属于画家一样？

区块链上的心灵创作：重新思考所有权

随着数字音乐的增长，以及最近的音乐流媒体服务，音乐行业将不得不考虑新的支付艺术家和评估创造力的方式。记得泰勒·斯威夫特与 Spotify 的斗争吗？区块链可能是解决方案吗？

企业家越来越多地转向区块链，以使内容分享对艺术家更加公平。根据 CB Insights 的说法，有几家公司正在利用智能合约，根据许可协议，自动根据购买创意作品产生的收入进行分发。

讨论数字权利和音乐，必然要提到流媒体服务的未来。这是一个例子。去年，Spotify 收购了 Mediachain，一家数字版权管理创业公司。Mediachain 一直在利用区块链技术解决归属问题——这是 Spotify 需要帮助的领域。在线科技行业出版物 TechCrunch 指出，它必须解决未支付版税的诉讼。3

*消除数字版权盗用*

区块链可以有效地消除数字权利盗用。它可以让艺术家自主发布他们的音乐，控制数据和使用条款，并通过智能合约实时分配版税。“如果任何人在世界上任何地方使用音乐文件，这个行为都会被公共区块链自动记录，并且交易会被验证。你就不会有数字权利盗用的问题，”Greg Cudahy，EY 全球领导者，在《区块链反应：技术计划达到临界质量》一文中解释说。4

开放音乐倡议 5 是一个寻求利用区块链技术解决版税纠纷的联盟。它没有建立一个平台。相反，它正在创建一个开源协议，用于统一识别音乐权利持有者和创作者。同样，其他公司，如旨在消除音乐领域中间人的 Audius6 和旨在改变事物混音方式的 Ujo Music7，可能会很快颠覆音乐行业。

*内容创作者最受苦*

成立于 2016 年的 SingularDTV 在 2019 年 1 月推出了其基于区块链的内容驱动的娱乐 dApp Breaker。在我们讨论期间，Breaker 的联合创始人兼首席执行官 Kim Jackson8 强调，区块链的主要组成部分——透明价值交换，帮助艺术家保留对他们创作的更多控制权。她说，“它可以确保对权利、收入和版税有完全控制，并建立艺术家与粉丝之间的直接关系。”

Jackson 解释说，

作为一名娱乐业的高管，我非常清楚独立电影公司所面临的问题。维持一种商业模式很难，因为这不允许你保留价值，而像 Netflix 和 Amazon 这样的中介却在提取价值。目前，这是将你的知识产权（IP）分发给大众的主要方式。

Jackson 指出，

如果你是一个内容创作者，并且你出售你的内容，你就会脱离这个等式。没有可持续的商业模式来继续产生收入，因为创作者被切断了与观众行为和收入报告相关的数据。你也与知识产权脱钩，因为你签署了你未来 15 年的权利。从独立内容创作者的角度来看，我们的商业模式有一个问题；我们正在学习区块链技术内在的所能提供的功能。

![](img/p0102.jpg)

**Gramatik** 制作人兼艺术家，亮相于 Alex Winter 的《信任机器：区块链的故事》，一部 Breaker 原创作品。版权：Breaker。
...
当 Mattereum 网络上的注册商被赋予某些资产的法律所有权时，他们可以通过链上智能合约设置资产可以被程序化购买、出售、租赁、分配和分割。授予的法律所有权还将用于解决争端和执行解决方案。
